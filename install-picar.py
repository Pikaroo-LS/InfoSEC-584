...
def main():
    ...
    main_input = input("Pikaroo > set_install ")

    # 01 - Information Gathering
    if main_input.strip() == "1" or main_input.strip() == "01":
        ...
        infogathering = input("Pikaroo > set_install ")
        if infogathering == "@":
            infogathering = ""
    ...
    # 02 - Vulnerability Analysis
    elif main_input.strip() == "2" or main_input.strip() == "02":
        print("\n    [01] Nmap: Utility for network discovery and security auditing")
        ...
        print("\n    [00] Back to main menu\n")
        vulnsys = input("Pikaroo > set_install ")
        if vulnsys == "@":
            vulnsys = ""
            for x in range(1,201):
                vulnsys += f"{x} "
    ...
    # 03 - Web Hacking
    elif main_input.strip() == "3" or main_input.strip() == "03":
        ...
        print("\n    [00] Back to main menu\n")
        webhack = input("Pikaroo > set_install ")
        if webhack == "@":
            webhack = ""
            for x in range(1,201):
                webhack += f"{x} "
    ...
    # 04 - Database Assessment
    elif main_input.strip() == "4" or main_input.strip() == "04":
        ...
        print("\n    [00] Back to main menu\n")
        dbssm = input("Pikaroo > set_install ")
        if dbssm == "@":
            dbssm = ""
            for x in range(1,201):
                dbssm += f"{x} "
    ...
    # 05 - Password Attacks
    elif main_input.strip() == "5" or main_input.strip() == "05":
        ...
        print("\n    [00] Back to main menu\n")
        passtak = input("Pikaroo > set_install ")
        if passtak == "@":
            passtak = ""
            for x in range(1,201):
                passtak += f"{x} "
    ...
    # 06 - Wireless Attacks
        ...
        print("\n    [00] Back to main menu\n")
        wiretak = input("Pikaroo > set_install ")
        if wiretak == "@":
            wiretak = ""
            for x in range(1,201):
                wiretak += f"{x} "
    ...
    # 07 - Reverse Engineering
        ...
        print("\n    [00] Back to main menu\n")
        reversi = input("Pikaroo > set_install ")
        if reversi == "@":
            reversi = ""
            for x in range(1,201):
                reversi += f"{x} "
    ...
    # 08 - Exploitation Tools
    elif main_input.strip() == "8" or main_input.strip() == "08":
        ...
        print("\n    [00] Back to main menu\n")
        exploitool = input("Pikaroo > set_install ")
        if exploitool == "@":
            exploitool = ""
            for x in range(1,201):
                exploitool += f"{x} "
    ...
    # 09 - Sniffing and Spoofing
    elif main_input.strip() == "9" or main_input.strip() == "09":
        ...
        print("\n    [00] Back to main menu\n")
        sspoof = input("Pikaroo > set_install ")
        if sspoof == "@":
            sspoof = ""
            for x in range(1,201):
                sspoof += f"{x} "
    ...
    # 10 - Reporting Tools
        ...
        print("\n    [00] Back to main menu\n")
        reportls = input("Pikaroo > set_install ")
        if reportls == "@":
            reportls = ""
            for x in range(1,201):
                reportls += f"{x} "
    ...
    # 11 - Forensic Tools
        ...
        print("\n    [00] Back to main menu\n")
        forensc = input("Pikaroo > set_install ")
        if forensc == "@":
            forensc = ""
            for x in range(1,201):
                forensc += f"{x} "
    ...
    # 12 - Stress Testing
        ...
        print("\n    [00] Back to main menu\n")
        stresstest = input("Pikaroo > set_install ")
        if stresstest == "@":
            stresstest = ""
            for x in range(1,201):
                stresstest += f"{x} "
    ...
    # 13 - Install Linux Distro
        ...
        print("    [10] Void Linux")
        print("\n    [00] Back to main menu\n")
        innudis = input("Pikaroo > set_install ")
        if innudis == "@":
            innudis = ""
            for x in range(1,201):
                innudis += f"{x} "
    ...
    # 14 - Termux Utility
        ...
        print("\n    [00] Back to main menu\n")
        moretool = input("Pikaroo > set_install ")
        if moretool == "@":
            moretool = ""
            for x in range(1,201):
                moretool += f"{x} "
    ...
    # 15 - Shell Function [.bashrc]
        ...
        print("\n    [00] Back to main menu\n")
        myshf = input("Pikaroo > set_install ")
        if myshf == "@":
            myshf = ""
            for x in range(1,201):
                myshf += f"{x} "
    ...
    # 16 - Install CLI Games
        ...
        print("\n    [00] Back to main menu\n")
        cligam = input("Pikaroo > set_install ")
        if cligam == "@":
            cligam = ""
            for x in range(1,201):
                cligam += f"{x} "
    ...
    # 17 - Malware Analysis
        ...
        print("\n    [00] Back to main menu\n")
        malsys = input("Pikaroo > set_install ")
        if malsys == "@":
            malsys = ""
            for x in range(1,201):
                malsys += f"{x} "
    ...
    # 18 - Compiler/Interpreter
        ...
        print("\n    [00] Back to main menu\n")
        compter = input("Pikaroo > set_install ")
        if compter == "@":
            compter = ""
            for x in range(1,201):
                compter += f"{x} "
    ...
    # 19 - Social Engineering Tools
        ...
        print("\n    [00] Back to main menu\n")
        soceng = input("Pikaroo > set_install ")
        if soceng == "@":
            soceng = ""
            for x in range(1,201):
                soceng += f"{x} "
        ...
        if readStatus():
            writeStatus(0)
    elif main_input.strip() == "99":
        os.system("git pull")
    elif main_input.strip() == "0" or main_input.strip() == "00":
        sys.exit()
